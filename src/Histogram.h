...
class TFT_Histogram 
{
  ...
  public:
        ...
        void formHistogram(String lable,int NO,double Histogram_value,int Histogram_WIDTH,uint32_t  colour);       //Input parameters about a histogram  
        ...
        void shrinkShowHistogram(int x,int y,int shrinkMultiple);                                               //The function is show histogram more little
...
//        void showHistogramMany();
  ...
  private:
       ...
       double histogramMax,histogramMin;                               //It is a value of high that histogramMax is to record the maximum value and histogramMin is to record the minimum value
